...
| [day 15](https://adventofcode.com/2020/day/15) | [`0.1ms`](./day15a/src/main.rs) | [`574ms`](./day15b/src/main.rs)  |

|              | one-by-one                             | parallel                                   |
|:-------------|:---------------------------------------|:-------------------------------------------|
| _everything_ | [`605ms`](./runner/src/bin/runner.rs)  | [`???ms`](./runner/src/bin/runner-par.rs)  |
